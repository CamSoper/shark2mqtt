...
REGIONS: dict[str, RegionConfig] = {
    "us": RegionConfig(
        ...
        ayla_login_url="https://user-field-v1-1a2w3bra.aylanetworks.com",
        ayla_device_url="https://ads-field-v1-1a2w3bra.aylanetworks.com",
        ayla_app_id="Shark-Android-field-id",
        ayla_app_secret="Shark-Android-field-id-Xs4GKmj",
    ),
    "eu": RegionConfig(
        auth0_url="https://login-eu.sharkninja.com",
        auth0_token_url="https://login-eu.sharkninja.com/oauth/token",
        auth0_client_id="JFyGelMv4kz1dEzfUn2Z2stXJUd9mNlL",
        auth0_redirect_uri="com.sharkninja.shark://login-eu.sharkninja.com/ios/com.sharkninja.shark/callback",
        ayla_login_url="https://user-field-eu-1a2w3bra.aylanetworks.com",
        ayla_device_url="https://ads-eu-1a2w3bra.aylanetworks.com",
        ayla_app_id="Shark-Android-EUField-Fw-id",
        ayla_app_secret="Shark-Android-EUField-Fw-id-aqCG2Dz",
    ),
}
